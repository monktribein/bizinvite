...
organizationsRouter.get("/:id/whatsapp-status", resolveTenantFromParam, requireAnyPermission("settings:manage", "campaigns:view"), controller.whatsAppStatus);
organizationsRouter.post("/:id/whatsapp/subscribe-webhooks", resolveTenantFromParam, requirePermission("settings:manage"), controller.subscribeWhatsAppWebhooks);
